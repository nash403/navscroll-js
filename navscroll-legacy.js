...
function handleClick(e) {
    ...
    var stop = options.stopPropagation === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().stopPropagation : options.stopPropagation;
    // keep default behavior of anchor link and update window.location
    var keepHrefDefault = options.anchor === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().anchor : options.anchor;
    // class to add to clicked element when scrolling is done
    var activeClass = options.activeClass === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().activeClass : options.activeClass;
    // callback called when scrolling is done
    var userOnDone = options.onDone && typeof options.onDone === "function" ? options.onDone : Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().onDone;
