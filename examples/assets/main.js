...
console.log('toto', __WEBPACK_IMPORTED_MODULE_1__navscroll___default.a);
new Vue({
  el: '#app',
  directives: {
  ...
  methods: {
    ...
    toto() {
      console.log("here");__WEBPACK_IMPORTED_MODULE_1__navscroll___default.a.setDefaults({ offset: 800 });console.log("after", __WEBPACK_IMPORTED_MODULE_1__navscroll___default.a.getDefaults());
    }
  }
});
...
(function webpackUniversalModuleDefinition(root, factory) {
    if (true) module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if (typeof exports === 'object') exports["NavScroll"] = factory();else root["NavScroll"] = factory();
})(this, function () {
    return (/******/function (modules) {
        ...
        /***/function (module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_exports__["a"] = getDefaults;
        ...
        /***/function (module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__default_easings__ = __webpack_require__(6);
        ...
        /***/function (module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__scrollTo__ = __webpack_require__(4);
            ...
            function handleClick(e) {
                ...
                const stop = options.stopPropagation === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().stopPropagation : options.stopPropagation;
                // keep default behavior of anchor link and update window.location
                const keepHrefDefault = options.anchor === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().anchor : options.anchor;
                // class to add to clicked element when scrolling is done
                const activeClass = options.activeClass === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().activeClass : options.activeClass;
                // callback called when scrolling is done
                const userOnDone = options.onDone && typeof options.onDone === "function" ? options.onDone : Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().onDone;
        ...
        /***/function (module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony export (immutable) */
            __webpack_exports__["b"] = setLocationHash;
            ...
            const scroller = () => {
                ...
                function scrollTo(target, _duration, options = {}) {
                    console.log('==>', Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])());
                    ...
                    container = __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* default */].$(options.container || Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().container);
                    duration = options.duration || Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().duration;
                    easing = options.easing || Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().easing;
                    offset = options.offset || Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().offset;
                    cancelable = options.cancelable !== false;
                    onDone = options.onDone || Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().onDone;
                    onCancel = options.onCancel || Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().onCancel;
                    x = options.scrollX === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().scrollX : options.scrollX;
                    y = options.scrollY === undefined ? Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])().scrollY : options.scrollY;
